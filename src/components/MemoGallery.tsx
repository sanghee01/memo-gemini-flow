...
import { Edit3, Trash2, Clock, Sparkles, Lock, Star, AlertCircle, Circle } from 'lucide-react';
...
export const MemoGallery: React.FC<MemoGalleryProps> = ({
  ...
  const getTitle = (memo: Memo) => {
    ...
    return firstLine.slice(0, 20) + (firstLine.length > 20 ? '...' : '') || '제목 없음';
  };
  ...
  const getColorClass = (color?: string) => {
    ...
    return color ? colorMap[color as keyof typeof colorMap] || 'bg-white border-gray-200' : 'bg-white border-gray-200';
  };
            ...
            <div className="p-4">
              <div className="flex items-start justify-between mb-2">
                ...
                <div className="flex items-center space-x-1 ml-2">
                  ...
                  {memo.isOrganized && <Sparkles className="w-3 h-3 text-purple-500" />}
                </div>
              </div>
